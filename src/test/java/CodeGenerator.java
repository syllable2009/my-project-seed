import static com.company.project.core.ProjectConstant.BASE_MODULE;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        //        genCode("输入表名");
        genCodeByCustomModelName("user_t", "User");
    }
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        //        pluginConfiguration.addProperty("lombok", "Data,EqualsAndHashCodeAndCallSuper");
        context.addPluginConfiguration(pluginConfiguration);

        //添加lombok插件
        PluginConfiguration lombokPluginConfiguration = new PluginConfiguration();
        lombokPluginConfiguration.setConfigurationType("com.company.project.core.LombokPlugin");
        lombokPluginConfiguration.addProperty("builder", "true");
        lombokPluginConfiguration.addProperty("allArgsConstructor", "true");
        lombokPluginConfiguration.addProperty("noArgsConstructor", "true");
        lombokPluginConfiguration.addProperty("accessors", "true");
        lombokPluginConfiguration.addProperty("accessors.prefix", "m_, _");
        lombokPluginConfiguration.addProperty("builder.builderMethodName", "myBuilder");
        ...
        sqlMapGeneratorConfiguration.setTargetPackage("mapper." + BASE_MODULE);
    ...
    public static void genService(String tableName, String modelName) {
        try {
            ...
            data.put("module", BASE_MODULE);

            File file =
                    new File(PROJECT_PATH + JAVA_PATH + PACKAGE_PATH_SERVICE + modelNameUpperCamel + "Service.java");
